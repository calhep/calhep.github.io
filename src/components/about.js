...
function About() {
    return (
        <div>
            ...
            <p>
                My name's Callum, and I'm a fifth year engineering physics student at the University of British Columbia with a coursework focus in computer science and machine learning.
            </p>
            <p>
